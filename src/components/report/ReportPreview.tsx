    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "14px" }}>
        ...
        <div style={{ flex: 1, textAlign: "center" }}>
          ...
          <p style={{ fontSize: "10px", color: "#374151", margin: "0 0 1px" }}>
      ...
      {sectionBox(
        form.permasalahan,
        "(Data deskripsi keluhan, gejala awal, dan permasalahan utama yang diinput oleh konselor/psikolog pada form digital akan terdokumentasi secara otomatis)"
      )}
      ...
      <hr style={{ borderColor: "#6b7280", marginBottom: "8px" }} />
      {sectionBox(
        form.prosesKonseling,
        "(Catatan perkembangan sesi konseling, dinamika psikologis, metode pendekatan intervensi yang diterapkan, serta respons klien sepanjang sesi akan terdokumentasi secara otomatis)"
      )}
      ...
      <hr style={{ borderColor: "#6b7280", marginBottom: "8px" }} />
      {sectionBox(
        form.saranPengembangan,
        "(Rekomendasi tindak lanjut, rencana intervensi klinis lanjutan, tugas mandiri untuk klien, atau saran pengembangan diri spesifik)"
      )}
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: "10px", fontWeight: 700, color: "#111827", margin: "0 0 2px" }}>
            Psikolog / Konselor
          </p>
          {psySignature ? (
            <div
          ...
          {psySipp ? (
            <p
              style={{ fontSize: "8px", color: "#6b7280", margin: "1px 0 0", fontStyle: "italic" }}
            >
              No. SIPP: {psySipp}
            </p>
          ) : null}
