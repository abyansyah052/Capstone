...
export function ReportCreator({
  ...
  const inputCls =
    "w-full px-3 py-2 rounded-xl border border-slate-200 bg-white text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-[#01696f] focus:ring-2 focus:ring-[#01696f]/10 transition-all";
    ...
    <div className="grid grid-cols-2 gap-3">
      <div className="col-span-2">
        ...
        <input
          ...
          placeholder="[Nama Lengkap Pasien/Klien]"
          className={inputCls}
        />
      </div>
      <div>
      ...
      <div className="col-span-2">
        ...
        <input
          ...
          placeholder="[Pendidikan Terakhir Klien]"
          className={inputCls}
        />
      </div>
      <div>
        ...
        <input
          disabled={isDisabled}
          value={form.anakKeberapa}
          onChange={(e) => set("anakKeberapa", e.target.value)}
          placeholder="ke [ ]"
          className={inputCls}
        />
      </div>
      ...
      <div className="col-span-2 mt-1 py-1 px-3 border border-slate-100 rounded-lg bg-slate-50 flex items-center justify-between">
        <span className="text-[12px] font-semibold text-slate-700">
          Pasien Konseling (Riwayat Klinis)
        </span>
        <input
          type="checkbox"
    ...
    <div className="fixed inset-0 z-50 bg-[#f7f6f2] flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 bg-white border-b border-slate-200 flex-shrink-0 gap-4">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-slate-400 hidden sm:block">
              Form akan otomatis mengisi preview di sebelah kanan
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            onClick={onClose}
            className="hidden sm:flex px-3.5 py-2 rounded-xl border border-slate-200 text-slate-600 text-sm font-medium hover:bg-slate-50 transition-all"
          >
            Batal
          </button>
          <button
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
                ...
                {bioTab === "manual" ? (
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between bg-[#01696f]/10 px-3 py-2 rounded-xl">
                      <span className="text-[11px] text-[#01696f] font-semibold">
                        Tersambung ke Database Pasien
                      </span>
                      <button
                        type="button"
                  ...
                  <div className="text-center py-5 px-3 border border-dashed border-slate-200 rounded-xl bg-white">
                    <span className="text-[11px] text-slate-400 font-medium leading-relaxed block">
                      Belum ada data pasien terdaftar di database. Silakan registrasi pasien
                      terlebih dahulu.
                    </span>
                  </div>
                ) : (
              ...
              <div className="bg-[#01696f]/[0.045] rounded-2xl p-4 flex flex-col gap-3 border border-[#01696f]/[0.08]">
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) => set("permasalahan", e.target.value)}
                    placeholder="(Deskripsi keluhan, gejala awal, dan permasalahan utama...)"
                    rows={4}
                    className={textareaCls}
                  />
                </div>
                <div>
                  ...
                  <textarea
                    value={form.prosesKonseling}
                    onChange={(e) => set("prosesKonseling", e.target.value)}
                ...
                <div>
                  ...
                  <textarea
                    value={form.diagnosisKlinis}
                    onChange={(e) => set("diagnosisKlinis", e.target.value)}
                ...
                <div>
                  ...
                  <textarea
                    value={form.saranPengembangan}
                    onChange={(e) => set("saranPengembangan", e.target.value)}
                    placeholder="(Rekomendasi tindak lanjut, rencana intervensi lanjutan...)"
                    rows={4}
                    className={textareaCls}
                  />
                </div>
        ...
        <div className="flex-1 overflow-auto bg-slate-300/80 flex items-start justify-center py-10 px-4 sm:px-8">
          <div
            style={{ transform: "scale(1)", transformOrigin: "top center", marginBottom: "80px" }}
          >
            <ReportPreview
              form={form}
