...
export type Batch = { id: string; name: string; company: string; color: string }
...
export type Patient = {
  ...
  // ── Field baru ──
  birthPlace: string      // tempatLahir
  education: string       // pendidikan
  siblingOrder: string    // anakKeberapa
  totalSiblings: string   // jumlahSaudara
  
  // ── Detail tambahan untuk edit ──
  dateOfBirth?: string
  occupation?: string
  country?: string
  province?: string
...
function PatientDirectoryConnected({
  patients, setPatients, onNew, onEdit,
}: {
  patients: Patient[]
