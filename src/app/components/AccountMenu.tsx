...
const C = {
  // Sidebar navy scale
  navy900: "#1C243B",   // deepest — sidebar bg, modal primary btn
  navy800: "#212C47",   // dropdown bg
  navy700: "#26324D",   // dropdown bg alt / hover on dark
  navy600: "#2d3a55",   // border on dark surfaces
  navy500: "#3a4a6a",   // subtle hover on dark
  // Gold accent (matches active nav item)
  gold:    "#E5B55C",
  goldDim: "rgba(229,181,92,0.15)",
  // Whites for dark surfaces
  ...
  // Light surface (modal)
  modalBg:     "#ffffff",
  surface:     "#F4F6F9",   // matches main content bg
  surfaceMd:   "#EEF1F6",
  border:      "#DDE2EC",
  borderFocus: "#1C243B",
  textPrimary: "#111827",
    ...
    <Modal onClose={onClose}>
      ...
      <div style={{ padding: "18px 22px 22px" }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <PrimaryBtn label="Save Changes" onClick={onClose} disabled={!value.trim()} />
        </div>
      </div>
    </Modal>
  )
